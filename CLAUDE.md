Update this MD as needed with progress.

open claw docs are in the directory in a folder call openclaw_docs send agents to explore them if you need. to understand context about open claw.
